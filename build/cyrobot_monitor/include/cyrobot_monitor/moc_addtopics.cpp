...
#include "../../../../src/cyrobot_monitor/include/cyrobot_monitor/addtopics.h"
...
QT_MOC_LITERAL(5, 48, 28), // "on_pushButton_cancel_clicked"
QT_MOC_LITERAL(6, 77, 24), // "on_pushButton_ok_clicked"
QT_MOC_LITERAL(7, 102, 21), // "slot_curritem_changed"
QT_MOC_LITERAL(8, 124, 7), // "current"
QT_MOC_LITERAL(9, 132, 8) // "previous"

    },
    "AddTopics\0Topic_choose\0\0QTreeWidgetItem*\0"
    "choose\0on_pushButton_cancel_clicked\0"
...
void AddTopics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Topic_choose((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        ...
        {
            typedef void (AddTopics::*_t)(QTreeWidgetItem * );
...
// SIGNAL 0
void AddTopics::Topic_choose(QTreeWidgetItem * _t1)
{
